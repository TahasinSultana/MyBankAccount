...
<style>
    ...
    <div class="columns">
	<h1 class="title column is-offset-4-desktop pt-5 has-text-white">EASY BANK LTD USER DASHBOARD</h1>
</div>


<div class="columns ml-3 ">
	<figure class="image is-32x32">
		<image class="is-rounded " src="image1.png"></image>
	</figure>
</div>
...
<div class="columns ml-4">
	...
	<form action="\BankProject/logout.php" method="post">
